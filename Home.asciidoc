...
We'd like to help developers build their own services by accessing user activity data tracked with our wearables (include Mi Band seris, Amazfit ARC / PACE / EQUATOR / MOONBEAM).
